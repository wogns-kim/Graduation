...
TAG_TO_CATEGORY_MAP = {
    # 여행 스타일
    #"힐링/휴양": ["공원", "수목원", "사찰", "휴양"],
    "힐링/휴양": ["전망대", "관광,명소", "공원","카페거리","하천"],

    #"액티비티": ["스포츠", "테마파크", "레저"],
     "액티비티": ["방탈출카페", "영화관","빌딩"],

    #"문화/역사": ["문화유산", "궁궐", "박물관", "미술관", "역사"],
     "문화/역사": ["문화", "문화유적", "문화시설", "박물관", "고궁"],

    #"쇼핑/시티 투어": ["쇼핑", "백화점", "거리", "랜드마크", "도시명소"],
    "쇼핑/시티 투어": ["시티투어", "관광,명소", "테마거리", "복합쇼핑몰", "도시명소","가정,생활"],

    #"미식/쇼핑": ["음식점", "맛집", "쇼핑", "시장"],
    "미식/쇼핑": ["음식점", "맛집", "쇼핑", "시장","카페"],
    ...
    "나 홀로 여행": ["패션","제과,베이커리","카페"], 
    "친구/지인": ["카페","문화,예술","가정,생활"],
    "가족 여행": ["가정,생활","관광,명소"],
    "펫 동반 여행": [""],
